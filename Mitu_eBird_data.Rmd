...
ebd_filt<-auk_ebd("ebd_CO-VAU_smp_relNov-2024/ebd_CO-VAU_smp_relNov-2024.txt",
                  file_sampling = "ebd_CO-VAU_smp_relMay-2024/ebd_CO-VAU_smp_relNov-2024_sampling.txt") %>%
...
#linea de tiempo
ggplot(ebd_only, aes(x = year(observation_date), fill = protocol_type))+
  geom_bar()+
  theme_classic()
...
Este grupo será el de nuestro foco para analisar diversidad de aves en tiempo y espacio:
```{r}
Mitu <- Coarse |>
