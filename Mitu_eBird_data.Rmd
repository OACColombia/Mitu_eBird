...
arrow_df <- data.frame(
      x = c(3,8), xend = c(5,10), y = c(0.04,0.06), yend = c(0.06,0.09),
...
arrow_df_Og <- data.frame(
      x = c(5,5), xend = c(1,10), y = c(0.06,0.06), yend = c(0.09,0.06),
      scientific_name = "Ortalis guttata", # Ties the arrow to facet "Thraupis episcopus"
      Season = "Ihirimi"
    )
arrow_df_Rt <- data.frame(
      x = c(8,8), xend = c(5,10), y = c(0.04,0.04), yend = c(0.05,0.055),
